...
import (
	"flag"
	"github.com/awasylew/talkkonnect"
	"fmt"
	"log"
	"os"
	"runtime/pprof"
...
func main() {
	...
	config := flag.String("config", "/home/talkkonnect/gocode/src/github.com/awasylew/talkkonnect/talkkonnect.xml", "full path to talkkonnect.xml configuration file")
...
func talkkonnectusage() {
	...
	fmt.Println("---------------------------------------------------------------------------------------")
	fmt.Println("-config=/home/talkkonnect/gocode/src/github.com/awasylew/talkkonnect/talkkonnect.xml")
